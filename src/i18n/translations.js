...
const tr = {
  ...
  home: {
    ...
    stats: [
      ...
      { value: '150+', label: 'Uzman Kadro' },
      { value: '30+', label: 'Tamamlanan Proje' },
      { value: '20+', label: 'İş Ortağı' },
    ],
    activity: {
      ...
      cta: 'Projeleri Gör',
      items: [
        { title: 'Fabrika & Endüstriyel Yapılar', desc: 'Üretim tesisleri, depo ve endüstriyel yapıların projelendirilmesi ve anahtar teslim inşası.' },
        { title: 'Konut Projeleri', desc: 'Modern mimari ile yüksek yaşam kalitesini buluşturan prestijli konut projeleri.' },
        { title: 'Taahhüt İşleri', desc: 'Planlamadan teslime kadar uçtan uca yönetilen anahtar teslim taahhüt hizmetleri.' },
      ],
    },
    about: {
  ...
  about: {
    ...
    profileP1: 'Çobantaş Gayrimenkul İnşaat, 1995 yılında Mustafa Çoban tarafından İstanbul’da kurulmuştur. Otuz yılı aşkın saha tecrübesiyle fabrika ve endüstriyel yapılardan konut projelerine, anahtar teslim taahhüt işlerine kadar geniş bir yelpazede çalışmalar yürütmektedir.',
    ...
    activityItems: [
      { title: 'Fabrika & Endüstriyel Yapılar', desc: 'Üretim tesisleri, depo ve endüstriyel yapıların projelendirilmesi ve inşası; fonksiyonelliği, geniş açıklıkları ve dayanıklılığı bir arada sunuyoruz.' },
      { title: 'Konut Projeleri', desc: 'Modern mimari ile yüksek yaşam kalitesini esas alan konut projeleri; estetiği ve konforu prestijli yaşam alanlarında buluşturuyoruz.' },
      { title: 'Taahhüt İşleri', desc: 'Anahtar teslim taahhüt hizmetleri; planlamadan teslime kadar tüm süreci tek elden, şeffaf ve takvime sadık biçimde yönetiyoruz.' },
    ],
...
const en = {
  ...
  home: {
    ...
    activity: {
      ...
      cta: 'View Projects',
      items: [
        { title: 'Factory & Industrial Buildings', desc: 'Design and turnkey construction of production facilities, warehouses and industrial structures.' },
        { title: 'Residential Projects', desc: 'Prestigious residential projects that combine modern architecture with a high quality of life.' },
        { title: 'Contracting Works', desc: 'Turnkey contracting services managed end to end, from planning to delivery.' },
      ],
    },
    about: {
  ...
  about: {
    ...
    profileP1: 'Çobantaş Real Estate & Construction was founded in 1995 by Mustafa Çoban in Istanbul. With over thirty years of field experience, it carries out a wide range of works, from factories and industrial structures to residential projects and turnkey contracting.',
    ...
    activityItems: [
      { title: 'Factory & Industrial Buildings', desc: 'Design and construction of production facilities, warehouses and industrial structures; combining functionality, wide spans and durability.' },
      { title: 'Residential Projects', desc: 'Residential projects centered on modern architecture and a high quality of life, uniting aesthetics and comfort in prestigious living spaces.' },
      { title: 'Contracting Works', desc: 'Turnkey contracting services; managing the entire process from planning to delivery from a single hand, transparently and on schedule.' },
    ],
